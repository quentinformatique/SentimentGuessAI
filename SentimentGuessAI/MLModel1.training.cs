...
namespace SentimentGuessAI
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\quent\source\repos\SentimentGuessAI\SentimentGuessAI\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=18,NumberOfTrees=110,MaximumBinCountPerFeature=114,FeatureFraction=0.901288743283756,LearningRate=0.999999776672986,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
